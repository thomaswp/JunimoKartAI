...
namespace StardewValley.Minigames
{
	public class MineCart
	{
		...
		private List<KeyValuePair<string, int>> _currentHighScores = new List<KeyValuePair<string, int>>();
		...
		public MineCart(int whichTheme, int mode)
		{
			...
			//if (Game1.soundBank != null)
			//{
				minecartLoop = Game1.minecartLoop;
				minecartLoop.Play();
				minecartLoop.Pause();
			//}
		...
		{
			if (false) // (Game1.IsChatting || Game1.textEntry != null)
			{
			...
			else
			{
				...
				button_pressed = Game1.AI.IsPressed(this);
		...
		{
			//Console.WriteLine(String.Join(", ", _tracks.Select(kvp => String.Join("+", kvp.Value.Select(t => t.ToString())))));
			//Console.WriteLine(player);
			UpdateInput();
			float delta_time = 1 / 60f; // (float)time.ElapsedGameTime.TotalSeconds;
			if (gamePaused)
			{
				delta_time = 0f;
			}
		...
		public void changeScreenSize()
		{
			...
			int viewport_width = Game1.viewport.Width;
			int viewport_height = Game1.viewport.Height;

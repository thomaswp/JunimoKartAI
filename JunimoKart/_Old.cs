...
namespace StardewValley.Minigames
{
	public class OldMineCart
	{
		...
		public void draw(SpriteBatch b)
		{
			...
			{
				string txtbestScore = "Best Score"; // Game1.content.LoadString("Strings\\StringsFromCSFiles:OldMineCart.cs.12115");
				b.DrawString(Game1.dialogueFont, "Finished: " + totalMotion, new Vector2(1f, 1f), Color.White, 0f, Vector2.Zero, 0.25f, SpriteEffects.None, 0f);
